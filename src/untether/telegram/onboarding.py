...
from .client import BotClient, TelegramClient, TelegramRetryAfter
...
def render_generic_capture_prompt(bot_ref: str) -> Text:
    return Text.assemble(
        f"  send /start to {bot_ref} in the chat you want untether to use "
...
def render_persona_tabs() -> Table:
    ...
    inactive_label = "untether @master"
